            ...
            <div class="projects">
              ...
              <div class="tableFilters form-inline ">
                <div class="col-md-2 col-xs-2">
                  <router-link class="btn btn-outline-dark" to='/app/tableau/action/Create/new'>Create Tableau</router-link>
                </div>
          ...
          <Datatable :columns="columns" :sortKey="sortKey" :sortOrders="sortOrders" @sort="sortBy" class="table-responsive">
            <tbody>
                <tr v-for="project in projects" :key="project.id">
                  <td><li></li></td>
                  <td>{{project.analytics_name}}</td>
                  <td>{{project.id}}</td>
                  <td>{{project.analytics_url}}</td>
                  <td>
                    <router-link :to="'/app/tableau/action/Update/'+project.id" :form="project" class="btn btn-outline-dark"  v-tooltip="'Edit '+project.menu_name" ><i class="fa fa-pencil" aria-hidden="true"></i></router-link>
                        &nbsp;
                    <router-link :to="'/app/tableau/action/Delete/'+project.id" :form="project" class="btn btn-outline-dark"  v-tooltip="'Delete '+project.menu_name" ><i class="fa fa-trash" aria-hidden="true"></i></router-link>
                  </td>
...
export default {
 ...
 data() {
        ...
        let columns = [
            {width: '5%', label: '', name: '' },
            {width: '20%', label: 'Analytic Name ', name: 'menu_name'},
            {width: '10%', label: 'Id', name: 'id'},
            {width: '50%', label: 'Analytics URL', name: 'menu_component'},
