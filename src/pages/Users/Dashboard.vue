            ...
            <div class="projects">
              ...
              <div class="tableFilters form-inline ">
                <div class="col-md-2 col-xs-2">
                  <router-link class="btn btn-outline-dark" to='/app/users/action/Create/new'>Create Account</router-link>
                </div>
...
export default {
 ...
 data() {
        ...
        let columns = [
            {width: '5%', label: '', name: '' },
            {width: '20%', label: 'User Name', name: 'name'},
            {width: '5%', label: 'User Id', name: 'id'},
            {width: '40%', label: 'User Email', name: 'email'},
