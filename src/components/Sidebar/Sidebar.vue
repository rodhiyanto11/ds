  ...
  >
    ...
    <ul class="sidebar-nav">
      ...
      <li class="headerLink" v-for="menu in menus">
        <a  v-if="menu.child" :activeItem="activeItem" class="collapsed d-flex" :href="'#'+menu.index" data-toggle="collapse" :data-parent="'#'+menu.index">
         <span class="icon">
           <i class="fi flaticon-layers"></i>
            </span>
            {{menu.header}}
            <div data-v-15d90710="" class="caretWrapper"><i class="fa fa-plus"></i></div>
        </a>
      
        <router-link v-else  :activeItem="activeItem" :to="menu.link" class="collapsed d-flex">
          <span class="icon">
           <i class="fi flaticon-layers"></i>
            </span>
            {{menu.header}}
          </router-link>                
        <ul  :activeItem="activeItem" :id="menu.index" class="collapse " v-if="menu.child" >
          <li  :activeItem="activeItem" v-for="child in menu.child">
            <!-- <a href="icons.html">Icons</a> -->
            <router-link  :activeItem="activeItem" :to="child.link" class="d-flex">{{child.header}}</router-link>
          </li>
        </ul>
      </li> 
    </ul>
